        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                $.each(taskList,function (i,n) {
                    ...
                    param +='<td>';
                    param +='<button type="button" class="btn btn-success btn-xs" onclick="window.location.href=\'${APP_PATH}/authcert/show.do?memberid='+n.memberid+'&taskid='+n.taskid+'\'"><i class=" glyphicon glyphicon-check"></i></button>';
