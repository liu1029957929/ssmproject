    ...
    <script>
        ...
        function applicationForAuth() {
            ...
            $.ajax({
                ...
                beforeSend:function () {
                    loadingIndex = layer.msg("认证中", {icon: 16});
                    return true;
                },
